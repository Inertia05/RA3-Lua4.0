...
-- #### 简介
-- Lua 是一种轻量级、快速、灵活的脚本语言，非常适合嵌入式开发、游戏开发和数据处理等场景。学习 Lua 的好处在于它的语法简洁易学，执行速度快，并且可以轻松嵌入到 C/C++ 项目中，极大地提高开发效率。现代许多应用程序和游戏引擎（如 Roblox、World of Warcraft、和 Adobe Lightroom）都采用 Lua 作为脚本引擎，方便开发人员扩展功能和实现高度可定制的行为。

-- Lua 在物联网（IoT）设备、游戏 AI、配置文件处理、数据解析、服务器脚本等众多领域也得到了广泛应用。如果你希望快速上手编程、开发高效的脚本系统或在现有软件中加入自定义功能，Lua 将是一个非常理想的选择。
...
-- https://www.lua.org/manual/4.0/manual.html#4.7
